...
import com.campus.jobagent.security.JwtAuthenticationFilter;
...
/**
 * 安全配置：无状态 JWT 认证 + 基于角色的接口授权 + 统一 CORS。
 *
 * <p>“苍穹权限模型”落地方式：认证（我是谁）由 JWT 承载；授权（我能访问哪些菜单/数据）
 * 由角色编码 + {@code @PreAuthorize} 表达式控制，数据权限在 Service 层按角色拼接查询条件。
 */
@Configuration
@EnableWebSecurity
